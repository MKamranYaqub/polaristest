...
export default function GlobalSettings() {
  ...
  const [activeTab, setActiveTab] = useState('btl'); // 'btl' or 'bridge'
  ...
  const handleMoveRowDown = (index, type) => {
    const maxIndex = type === 'btl' ? btlRowOrder.length - 1 : bridgeRowOrder.length - 1;
  ...
  return (
    <div className="slds-p-around_medium">
      ...
      <div className="slds-grid slds-wrap slds-m-bottom_x-large" style={{ gap: '1.5rem' }}>
        
        {/* BTL Calculator Settings */}
